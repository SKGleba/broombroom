...
int siofix(void* func) {
    int (*create_thread)(const char* name, void* func, int a2, int a3, int a4, int a5, int a6) = KFUN("SceKernelThreadMgr", 0x5e34 | 1);
    int (*start_thread)(int id, int argsz, void* argv) = KFUN("SceKernelThreadMgr", 0x7c5c | 1);
    int (*wait_thread)(int id, int* ret, void* argv) = KFUN("SceKernelThreadMgr", 0x719c | 1);
    int (*delete_thread)(int id) = KFUN("SceKernelThreadMgr", 0x64bc | 1);
    int ret, res, uid;
